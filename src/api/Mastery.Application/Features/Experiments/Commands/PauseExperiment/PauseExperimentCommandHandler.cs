...
public sealed class PauseExperimentCommandHandler : ICommandHandler<PauseExperimentCommand>
{
    private readonly IExperimentRepository _experimentRepository;
    private readonly ICurrentUserService _currentUserService;
    private readonly IUnitOfWork _unitOfWork;

    public PauseExperimentCommandHandler(
    ...
    public async Task Handle(PauseExperimentCommand request, CancellationToken cancellationToken)
    {
