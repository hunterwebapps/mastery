...
namespace Mastery.Infrastructure.Migrations
{
    ...
    [Migration("20260201183806_AddTraceDebugFields")]
    partial class AddTraceDebugFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Mastery.Domain.Entities.Recommendation.RecommendationTrace", b =>
                {
                    ...
                    b.Property<string>("PolicyResultJson")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ProcessingWindowType")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                    ...
                    b.Property<string>("Tier0TriggeredRulesJson")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Tier1EscalationReason")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("Tier1ScoresJson")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("FinalTier");

                    b.HasIndex("ProcessingWindowType");
