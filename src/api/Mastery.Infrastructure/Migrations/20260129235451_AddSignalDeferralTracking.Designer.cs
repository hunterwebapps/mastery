...
namespace Mastery.Infrastructure.Migrations
{
    ...
    [Migration("20260129235451_AddSignalDeferralTracking")]
    partial class AddSignalDeferralTracking
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Mastery.Domain.Entities.Signal.SignalEntry", b =>
                {
                    ...
                    b.Property<DateTime?>("NextProcessAfter")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("Status", "Priority", "NextProcessAfter", "CreatedAt")
